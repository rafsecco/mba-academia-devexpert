...
public class Validacoes
{
	...
	public static void ValidarSeMenorIgualQue(long valor, long minimo, string mensagem)
	{
		if (valor <= minimo)
		{
			throw new DomainException(mensagem);
	...
	public static void ValidarSeMenorIgualQue(double valor, double minimo, string mensagem)
	{
		if (valor <= minimo)
		{
			throw new DomainException(mensagem);
	...
	public static void ValidarSeMenorIgualQue(decimal valor, decimal minimo, string mensagem)
	{
		if (valor <= minimo)
		{
			throw new DomainException(mensagem);
	...
	public static void ValidarSeMenorIgualQue(int valor, int minimo, string mensagem)
	{
		if (valor <= minimo)
		{
			throw new DomainException(mensagem);

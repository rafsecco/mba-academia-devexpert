...
public class MatriculaConfirmadaEvent : IntegrationEvent
{
	...
	public MatriculaConfirmadaEvent(Guid matriculaId, decimal valor, Guid alunoId, Guid cursoId, string nomeCartao, string numeroCartao, string expiracaoCartao, string cvvCartao)
	{
		AlunoId = alunoId;
		CursoId = cursoId;
